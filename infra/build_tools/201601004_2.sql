CREATE TABLE PERSON(
    ...
    GWA FLOAT8,
    DATE_HIRED DATE,
    EMPLOYED BOOLEAN USING CASE WHEN EMPLOYED = 'Y' THEN TRUE
                          WHEN EMPLOYED = 'N' THEN FALSE END,
...
CREATE TABLE CONTACTS(
    ...
    UNIQUE (PERSON_ID, CONTACT_TYPE, CONTACT_EMAIL),
    UNIQUE (PERSON_ID, CONTACT_TYPE, CONTACT_NUMBER)
);
